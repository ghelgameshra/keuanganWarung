    ...
    <table class="w-full text-sm text-left text-dark-secondary bg-slate-100 rounded-lg">
        <tbody>
            ...
            <tr class="border-b-gray-200 border-b-[1px]">
                ...
                <td class="px-6 py-2">
                    <input type="text" value="{{ $laporan->Karyawan->nama_karyawan }}" class="laporan-input"
                        readonly>
                </td>
            </tr>
            ...
            <tr class="border-b-gray-200 border-b-[1px]">
                ...
                <td class="px-6 py-3">
                    <input type="text" class="laporan-input" value="{{ tanggal_indonesia($laporan->created_at) }}"
                        readonly>
                </td>
            </tr>
            ...
            <tr class="border-b-gray-200 border-b-[1px]">
                ...
                <td class="px-6 py-3">
                    <input type="text" class="laporan-input" value="{{ $laporan->created_at->format('H:m:s') }}"
                        readonly>
                </td>
            </tr>
            ...
            <tr class="border-b-gray-200 border-b-[1px]">
                ...
                <td class="px-6 py-3">
                    <input type="text" class="laporan-input" value="Rp. {{ format_uang($laporan->aktual_kas) }}"
                        readonly>
                </td>
            </tr>
                ...
                <tr class="border-b-gray-200 border-b-[1px]">
                    ...
                    <td class="px-6 py-3">
                        <input type="text" class="laporan-input"
                            value="{{ tanggal_indonesia($laporan->updated_at) }}" readonly>
                    </td>
                </tr>
            @endif
            ...
            @if ($laporan->checker_id != null)
                ...
                <tr class="border-b-gray-200 border-b-[1px]">
                    ...
                    <td class="px-6 py-3">
                        <input type="text" class="laporan-input" value="{{ $laporan->Checker->nama_karyawan }}"
                            readonly>
                    </td>
                </tr>
            @endif
...
<a href="/dashboard/laporan/{{ $laporan->id_laporan }}/edit"
    class="p-3 text-center w-full bg-yellow-400 rounded-lg text-white mt-3 flex items-center justify-center gap-3">
