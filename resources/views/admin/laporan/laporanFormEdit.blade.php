    ...
    <table class="w-full text-sm text-left text-dark-secondary bg-gray-100 rounded-lg">
      <tbody>
        ...
        <tr class="border-b-gray-200 border-b-[1px]">
          ...
          <td class="px-6 py-3">
            <input type="text" name="input_aktual_kas" class="laporan-input" placeholder="Rp. "
        ...
        <tr class="border-b-gray-200 border-b-[1px]">
          ...
          <td class="px-6 py-3">
            <input type="text" name="tabungan" class="laporan-input" value="Rp. {{ format_uang($laporan->tabungan) }}"
              readonly>
          </td>
        </tr>
        ...
        <tr class="border-b-gray-200 border-b-[1px]">
          ...
          <td class="px-6 py-3">
            <input type="text" name="aktual_kas" class="laporan-input"
