<form action="/dashboard/setor" method="POST" enctype="multipart/form-data">
  @csrf
  <div class="relative overflow-x-auto shadow-lg sm:rounded-lg rounded-lg py-3 bg-gray-50">
    <table class="w-full text-sm text-left text-dark-secondary dark:text-gray-400">
      <tbody>
        ...
        <tr class="border-b border-gray-200 dark:border-gray-700">
          ...
          <td class="px-6 py-2 bg-gray-50 dark:text-white dark:bg-gray-800">
            <input type="text" value="{{ auth()->user()->Karyawan->nama_karyawan }}" class="laporan-input w-full" readonly>
          </td>
        </tr>
        ...
        <tr class="border-b border-gray-200 dark:border-gray-700">
          ...
          <td class="px-6 py-2 bg-gray-50 dark:text-white dark:bg-gray-800">
            <textarea name="keterangan" rows="3" class="laporan-input w-full text-sm" placeholder="Boleh kosong. @error('keterangan') {{ $message }} @enderror"></textarea>
          </td>
        </tr>
  ...
  <button class="p-3 text-center w-full bg-green-500 rounded-lg text-white mt-3 flex justify-center items-center gap-2 font-bold mb-5" type="submit" onclick="return confirm('lanjut setor harian ?')">
