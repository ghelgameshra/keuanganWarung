...
<body class="h-screen flex flex-col main-bg">
  <nav class="text-white w-full shadow-md px-10 py-5 flex items-center">
    <div>
      <h1 class="font-bold">Monitoring Keuangan</h1>
    </div>
    <div class="ml-auto">
      <button id="sidebarButton" class="focus:outline-none focus:ring-0">
    ...
    <div class="border p-10 rounded-md flex flex-col bg-white">
      ...
      <form action="/" method="POST" class="flex flex-col gap-5">
        ...
        <div class="flex items-center justify-center shadow-sm w-full">
          ...
          <input id="email" type="text" class="rounded-r-md border-r border-y p-2 focus:ring-0 focus:outline-none w-10/12" name="email" autocomplete="off" autofocus placeholder="Email" value="{{ old('email') }}">
        </div>
        ...
        <div class="flex items-center justify-center shadow-sm relative w-full">
          ...
          <input id="password" type="password" class="rounded-r-md border-r border-y p-2 focus:ring-0 focus:outline-none w-10/12" name="password" autocomplete="off" autofocus placeholder="*********" value="{{ old('password') }}">

          <button type="button" class="absolute right-3 text-base text-gray-400 sm:right-6" onclick="showPassword()">
